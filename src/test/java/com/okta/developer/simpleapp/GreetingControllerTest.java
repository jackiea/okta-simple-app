...
public class GreetingControllerTest {
    ...
    void testGreet() throws Exception {
        ...
        OAuth2AuthenticationToken oAuth2AuthenticationToken = createMockOAuth2AuthenticationToken(idToken);
        this.mvc.perform(get("/greeting").with(authentication(oAuth2AuthenticationToken)))
    ...
    private OidcIdToken createOidcIdToken() {
